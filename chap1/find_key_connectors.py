...
for user in users:
    # add a friends key to the user dict. value is a list.
    user["friends"] = []
...
def most_common_interests_with(user):
    ...
    return Counter(interested_user_id
                   # iterate user's interests
                   for interest in interests_by_user_id[user['id']]
                   # for each interest iterate over users with that interest
